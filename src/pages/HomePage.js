 ...
 * @version      4.2.0 (Order Book & Multi-Asset Edition)
 ...
 *               high-frequency execution tape.
 * @license      Institutional Private Build
 */
...
const HomePage = (props) => {
  ...
  useEffect(() => {
    ...
    const performSystemSync = () => {
        ...
        fetch('/whales.json' + cacheBuster)
            ...
            .then(data => {
                ...
                console.log("Terminal Heartbeat Success:", new Date().toLocaleTimeString());
            })
            .catch(error => {
    ...
    // UI REFINEMENT: Suppression of legacy third-party overlays
    ...
    cleanTerminalUI();
    setTimeout(cleanTerminalUI, 2500); // Delayed secondary pass
  ...
  const handleInstitutionalRedirect = (origin) => {
    ...
    // Stable Gateway Hub optimized for the Indian Market
          ...
          <div className="container-fluid" style={{ maxWidth: "1500px", margin: "0 auto", padding: "0 40px" }}>
            ...
            <div style={styles.dashboardGrid}>
                ...
                <div style={styles.dashboardCard}>
                    ...
                    <span style={styles.liveTag}>SENTIMENT INDEX v2.1</span>
                </div>
...
const styles = {
  ...
  // FIXED 6-COLUMN GRID FOR SENTIMENT + 5 COINS
  dashboardGrid: { 
    display: "grid", 
